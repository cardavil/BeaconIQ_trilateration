...
public class BleScanner {
    ...
    /**
     * Manual Apple iBeacon parser. NOT used in the live scan path — AltBeacon's
     * configured parsers handle iBeacon framing in production. Kept as a
     * unit-tested fallback/reference (see BleScannerRoutingTest); confirm before
     * removing.
     */
